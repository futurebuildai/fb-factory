export const LEGAL_POLICY_METADATA = [
  ...
  },
  {
    ...
    description: "Rules for safe and lawful use of FB Factory hosted services.",
  ...
  },
  {
    ...
    slug: "ai-terms",
    title: "AI Terms",
    description: "Terms for AI features in FB Factory hosted services.",
  ...
  },
  {
    ...
    description:
      "Plain-English rules for content and applications on FB Factory hosted infrastructure.",
  ...
  },
  {
    ...
    description:
      "How the Service operator responds to government requests for hosted FB Factory information.",
