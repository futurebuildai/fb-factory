...
This policy explains how the Service operator responds to requests from law enforcement and other government authorities for hosted application user or end-user information. We are committed to protecting users' data and disclose information only when legally required. This policy is informational and does not create rights for any party or waive any objection we may raise.
...
We respond to requests from government authorities outside the United States through applicable international legal cooperation mechanisms, such as a mutual legal assistance treaty (MLAT), and may direct requesting authorities to those channels.

Where a request seeks personal data protected by GDPR, we will assess the request under applicable data protection law, including the rules governing international data transfers, and will act consistently with our data processing agreements and any applicable standard contractual clauses.

3. Notice to Users

Our policy is to notify the affected user of a request for their information and to provide a reasonable opportunity to object before disclosing, unless prohibited by law, court order, or where we believe in good faith there is a risk of imminent harm.

Where a request is accompanied by a valid nondisclosure or gag order issued by a court, we will withhold notice for the period per the terms of the court order and will notify the user when permitted by such order.
...
The information available depends on the account and Service used, and may include basic account information such as name and email and, subject to appropriate legal process, certain logs or content. We cannot provide information we do not retain.

7. Cost Reimbursement

We may seek reimbursement for the reasonable costs of responding to requests, where permitted by law or pursuant to the terms of the applicable written agreement.
