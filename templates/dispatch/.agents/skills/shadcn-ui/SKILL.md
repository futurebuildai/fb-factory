...
2. In an FB Factory app, inspect `app/design-system.ts` and
...
- FB Factory apps use `@tabler/icons-react`. Do not add `lucide-react` because a registry example used it.
