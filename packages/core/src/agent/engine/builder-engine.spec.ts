...
describe("createBuilderEngine", () => {
  ...
  it("resolves auto to the FB Factory default before posting to the gateway", async () => {
    const fetchSpy = vi
      .fn()
      .mockResolvedValue(
        jsonlResponse([
  ...
  it("routes upgradeUrl to the org-agnostic subscription page with FB Factory attribution", async () => {
