...
export const TEMPLATES: TemplateMeta[] = [
  ...
  },
  {
    name: "analytics",
    label: "Analytics",
    hint: "FB Factory Amplitude/Mixpanel - connect data sources, prompt for charts",
    icon: "BarChart2",
    color: "#F59E0B",
    colorRgb: "245 158 11",
    devPort: 8088,
  ...
  },
  {
    name: "fb-ops",
    label: "FB Ops",
    hint: "Read-only platform operations for FutureBuild Cloud",
    icon: "Activity",
    color: "#452e72",
    colorRgb: "69 46 114",
    devPort: 8102,
    prodUrl: "https://fb-ops.agent-native.com",
    hidden: true,
    defaultMode: "dev",
    core: false,
  },
